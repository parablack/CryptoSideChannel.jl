...
# Encrypts the given plaintext block using the given key
# and returns the resulting ciphertext.
# Both the plaintext and key are arrays holding bytes of type Any.
# The returned ciphertext is an array holding bytes of type Any.
